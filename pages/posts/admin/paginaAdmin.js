  ...
  <div className="col-sm-6">
    ...
    <h5 className="card-header">Pesquisas</h5>
      <div className="card-body">
        <Link href="/posts/admin/todos/pesquisa"><a className="btn btn-primary">Ir as Pesquisas</a></Link>
...
<div className="row mt-2">
  <div className="col-sm-6">
    ...
    <h5 className="card-header">Cursos</h5>
      <div className="card-body">
        <Link href="/posts/admin/todos/curso"><a className="btn btn-primary">Ir aos Cursos</a></Link>
  ...
  <div className="col-sm-6">
    ...
    <h5 className="card-header">Docentes</h5>
      <div className="card-body">      
        <Link href="/posts/admin/todos/docente"><a className="btn btn-primary">Ir aos Docentes</a></Link>
        <Link href="/posts/admin/cadastrar/docente"><a className='btn btn-success ms-2'>Cadastrar</a></Link>
      </div>
    </div>
  </div>
</div>
...
<div className="row mt-2">
  <div className="col-sm-6">
    ...
    <h5 className="card-header">Discentes</h5>
      <div className="card-body">
        <Link href="/posts/admin/todos/discente"><a className="btn btn-primary">Ir aos Discentes  </a></Link>
  ...
  <div className="col-sm-6">
    ...
    <h5 className="card-header">Matricula</h5>
      <div className="card-body">
        <Link href="/posts/admin/todos/matricula"><a className="btn btn-primary">Ir as Matriculas  </a></Link>
