...
export default function AlterarDiscente({ discentes, Auth }) {
  const usuario = Auth
        ...
        <fieldset>
          ...
          <div className="input-group mb-3">
            ...
            <input
              ...
              value={discente.nome}
              defaultValue={discentes.nome}
              placeholder={discentes.nome}
          ...
          <div className="input-group mb-3">
            ...
            <input
              ...
              type="text"
              onChange={handleInputChange}
              defaultValue={discentes.matriculaId}
              placeholder={discentes.matriculaId}
          ...
          <div className="input-group mb-3">
            ...
            <input
              ...
              defaultValue={discentes.email}
              placeholder={discentes.email}
              className="form-control"
              aria-label="Username"
              aria-describedby="basic-addon1"
            />
          ...
          <div className="input-group mb-3">
            ...
            <input
              ...
              defaultValue={discentes.data_nascimento}
              placeholder={discentes.data_nascimento}
              className="form-control"
              aria-label="Username"
              aria-describedby="basic-addon1"
            />
          ...
          <div className="input-group mb-3">
            ...
            <input
              ...
              onChange={handleInputChange}
              value={discente.cpf}
              defaultValue={discentes.cpf}
              className="form-control"
              placeholder={discentes.cpf}
              maxLength="11"
              aria-label="Username"
              aria-describedby="basic-addon1"
            />
