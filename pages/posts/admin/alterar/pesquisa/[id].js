...
export default function AlterarPesquisa({
  attributes,
  attributes1,
  attributes2,
  Auth,
  ...
  const Protecaoderota = () => {
    ...
    return usuario ? (
      <div className="container-fluid g-0">
        <Head>
          <title>Alterar {attributes2.titulo}</title>
        </Head>
        <HeaderAdmin />
        <ToastContainer />
        <div className="container">
          <form onSubmit={handleSubmit}>
            <fieldset className="border rounded p-3 mt-2">
              <legend>Alterar informações de uma Pesquisa</legend>
              ...
              <div className="input-group mb-3">
                ...
                >
                  ...
                  <option value="Registro de Software">
